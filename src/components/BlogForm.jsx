...
const BlogFormWithImages = ({ blogData = {}, onSave, goback }) => {
  const [formData, setFormData] = useState({
    id: blogData.id || "",
    title: blogData.title || "",
    content: blogData.content || "",
    submittedBy: blogData.submittedBy || "",
    status: blogData.status || 0,
    imageurls: blogData.imageurls || [],
    likes: blogData.likes || "",
    comments: blogData.comments || [], // Array to store comments
  });
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      removedImages: blogData.imageurls.filter(
        ...
        <form onSubmit={handleSubmit} onKeyDown={handleKeyDown}>
          ...
          <div className="text-center">
            <CommonButton
              ...
              disabled={loading}
            >
              {blogData.id ? "Update Blog" : "Create Blog"}
            </CommonButton>
          </div>
          {/* Message Display */}
          {message && (
...
export default BlogFormWithImages;
